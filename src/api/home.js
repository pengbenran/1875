...
export default {
	...
	getCode(code){		
	 ...
	 return API.GetCode('http://192.168.0.116/1875/api/member/getMemberinfo',{code:code})

	},
	// 获取用户信息并且注册会员  
	weCatLogin(params){
		return API.getLogin('http://192.168.0.116/1875/api/member/weChatLogin',params)
